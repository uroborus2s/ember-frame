...
这个项目围绕文明被篡夺、航权被摧毁、历史被重写之后，幸存者如何重新理解故土展开。人和 AI 的统一制作入口是 [《断航故土》制作总入口](project/severed-homeland/index.md)，当前进度、正式输入、版本规则和从创意到成片的完整流程都从这里进入。
...
- AI 剧项目按 `创意立项 -> 故事 Bible -> 小说 -> 剧本 -> 导演分镜 -> 美术/配音/音乐/提示词 -> 视频生成 -> 剪辑 -> 成片交付` 推进；具体项目以自己的 `index.md` 和 `project-management.md` 为准。
