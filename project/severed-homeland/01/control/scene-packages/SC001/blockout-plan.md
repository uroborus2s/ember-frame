...
用同一个 Blender 场景验证 `r001e01.png`、`r002e01.png`、`r003e01.png`、`r004e01.png` 四个参考帧是否来自同一面锁喉关黑石城墙、同一个城门、同一座门楼和同一口昭明旧帝国金属警钟。低模不是最终美术图，而是空间、机位、深度、线稿和后续生图 ControlNet/参考图的证据。

## 搭建顺序

1. 按 `layout.yaml` 建立坐标系、墙体、城门、女墙、门楼主体、门楼木架、钟架、昭明旧帝国金属警钟、旗帜、攻城梁/猛犸角、兽族剪影、守军枪线和低细节城内侧远景背板。
2. 放置年轻军户、脱手断矛、薛临墙和墙顶守军剪影。
3. 建立统一材质/程序化贴图层：黑石噪声、石缝、缺口、积雪边、木纹、门板缝、铁箍、铆钉、旧金属警钟裂痕、破损昭明日月星盘残徽、P017 白翅旗纹和城内侧背板暗窗。
4. 建立四个分镜摄像机：
...
- R003 必须位于门楼内侧，按前景断矛、中景被震倒但仍活着的军户、后景旧金属警钟三层组织。
- R004 必须从门楼后侧看向薛临墙与外侧女墙，后景仍可保留同一旧金属警钟空间锚点，墙外不得出现房屋或城市街区。
- 顶视图中攻城方向只能从 `y<0` 向 `y=0`，不得出现城内侧兽潮。
- 旧金属警钟位置在所有可见镜头中必须保持 `[-4.8, 5.7, 13.2]` 附近，不得漂移。
