...
B04_E01_STYLE 已完成并通过协调端视觉 QC。三张 episode style reference 已写入 canonical 路径，尺寸满足各自 output_format；下游角色、地点、道具服装、参考帧和 shot override 批次可以继续分发。
...
- B01_E01_CHARACTERS
- B02_E01_LOCATIONS
- B03_E01_PROPS_COSTUMES
- B05_E01_REFERENCE_FRAMES
- B06_E01_SHOT_OVERRIDES
