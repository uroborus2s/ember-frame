...
- format_conflict_9x16_vs_1x1: 33
- subject_too_thin: 27
...
|---|---|---:|---:|---:|---:|---|
| PROMPT_E01_C001 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
| PROMPT_E01_C002 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
...
| PROMPT_E01_C006 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
| PROMPT_E01_C007 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
...
| PROMPT_E01_C017 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
...
| PROMPT_E01_C023 | character | 65 | 12 | 12 | 6 | missing_prompt_reference_inputs, missing_copy_ready_reference_image_instructions, visible_production_usage_label, format_conflict_9x16_vs_1x1 |
...
第一集提示词内容本身多数能描述剧情资产，但还没有达到全剧提示词新模板的 100 分标准。主要缺口不是长度，而是继承执行层：83 条提示词全部缺少 `production_metadata.reference_inputs`，也全部缺少 `copy_ready.reference_image_instructions`，导致全局父资产和本集依赖只停留在 `asset-index.json`，生成时不一定会被模型实际使用。另有 83 条可见提示词带“第01集/审核用视觉资产参考”等生产用途文字，40 条参考帧存在 `。。` 或英文模板残句，33 条资产卡同时写 9:16 与 1:1，存在目标格式冲突。
...
5. 统一资产卡输出格式：卡片不要同时写 `9:16竖屏` 与 `1:1中性资产卡`；参考帧才保留视频帧比例和前中后景要求。
