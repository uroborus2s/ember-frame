...
- Scope: `PROMPT_C001`-`PROMPT_C011`; C023-C026 remain pending separate dispatch/review
- Status: `partial_complete_qc_passed_c008_generated_remaining_pending_dispatch`
- Date: 2026-06-06
...
| C008 | PROMPT_C008 | `assets/characters/c008m.png` | generated, QC passed, pending art review |
...
No C008 retry block remains after the 2026-06-06 regeneration. Remaining B01 assets not generated or not QC-passed in this pass: C023, C024, C025, C026.
...
### C008 Insect-General Correction

C008 was regenerated after the latest insect-general feedback. The accepted card keeps 厉螳 as an insect-face commander, not a human face wearing a mask: hard head shell, dark compound-eye texture, mandible plates, antennae, and bone-white jaw armor remain the primary face structure while only the command expression reads partly humanoid.

The accepted C008 card also locks the limb and status rules: the main arms retain usable hands for holding and pointing, dagger blades sit on the outside of the main forearms as arm-blade armor, and the feet are enclosed in boot-like armored coverings rather than bare claws. Armor color is separated into black-green chitin, bone-white blade/jaw accents, oxidized copper/iron, and dark cinnabar cords.
...
- C008 source image: `/Users/uroborus/.codex/generated_images/019e97cd-3447-7613-83a3-80cefad15700/ig_04e84ef91b261af9016a23186dbf34819391dd354b2a10aa69.png`
...
- C008 final SHA-256: `ee2c93cfed939934c5596ce01d20d636949c6686915f14478a82d71d9a910ac1`
...
Remaining B01 assets not generated or not QC-passed in this pass: C023, C024, C025, C026.
