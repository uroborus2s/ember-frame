...
- Scope: `PROMPT_C012` through `PROMPT_C015`, `PROMPT_C017` through `PROMPT_C020`; `PROMPT_C016` blocked for retry
- Status: `partial_complete_qc_passed_c016_blocked_retry_needed`
- Date: 2026-06-05
...
| --- | --- | --- | --- | --- |
| C016 | PROMPT_C016 | `assets/characters/c016m.png` | blocked, not present at canonical output | 虫吏需要重新生成：虫脸本体，50% 拟人度；脸部必须是自然对称的虫族生物结构，不能是人脸贴虫壳或侧边异物；官服以白为主，配绯色和青色；高级虫族官吏必须有鞋/靴式足具。被拒候选已归档为 `assets/characters/history/c016m.v001.png`。 |

## Output Contract QC

| Check | Result |
| --- | --- |
| Exact canonical path | pass for C012-C015 and C017-C020 |
| Short basename <= 20 chars | pass for C012-C015 and C017-C020 |
| PNG format | pass for C012-C015 and C017-C020 |
| 2160x3840 minimum resolution | pass for C012-C015 and C017-C020 |
| Opaque / no alpha | pass for C012-C015 and C017-C020 |
| 9:16 vertical card format | pass for C012-C015 and C017-C020 |
| Neutral master character card, not video frame | pass for C012-C015 and C017-C020 |
...
- Remaining B02 assets not generated or not QC-passed in this pass: C016, C021.
