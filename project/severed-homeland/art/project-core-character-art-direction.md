...
- Global style: `assets/style/project-style-board/style_global_mood_low_magic_eastern_epic_v01.png`
...
Shen Weisang is a 17-year-old Canyang Ao hunter and guide, descended from old relay-road surveyors. He is lean, hard, and watchful, but still visibly a youth. His face should keep a young jawline and guarded clear eyes. Long-term archery and a left-shoulder injury create slight asymmetry in posture and equipment placement.

Core visual anchors:

- grey-brown short hunter layers
- washed herb-green inner garment
- old leather wrist guards
...
1. Three full-body standing states across the top or middle:
   - Canyang Ao hunter state before the fire: clean but worn, practical and village-rooted.
   - Post-fire fugitive state: same silhouette, charred hem, smoke dulling, repaired shoulder and elbow, lighter route pack.
   - Border snowline state: grey hemp cloak, old leather shoulder protection, snowline leg wraps, still not military armor.
2. Detail panels:
   - front face and hair, still age 17
   - left shoulder asymmetry and old leather guard
...
### Canyang Ao Hunter State

Use grey-brown short practical layers with washed herb-green inner garment. Clothing is worn by labor and travel but still clean enough to show construction. The hunter identity must be readable from the bow, wrist guard, cord, route pouch, water bag, and boots.

### Post-Fire Fugitive State

Keep the exact hunter silhouette. Add smoke dulling, a charred lower hem, small repair stitches, shoulder and elbow reinforcement, and a lighter route pack. Do not turn him into a mud-covered refugee or ragged beggar.
...
- black hair with red cord
- mist-purple or cold-grey fugitive outer robe
- deep ink-blue inner structure
- moon-white jade hidden close to the body
- blood-writ packet and old paper held in inner pouch
- small black lacquer case
...
1. Three full-body standing states:
   - Fugitive concealment state: mist-purple/cold-grey travel robe, red hair cord, deep ink-blue inner layer, hidden moon-white jade and blood writ, no visible sun-moon badge on the front layer.
...
2. Detail panels:
   ...
   - moon-white jade fragment and black lacquer case
   - formal robe worn-gold embroidery and inherited sun-moon dark pattern, copied from existing symbol language without redesign
   - snowline cloak clasp and hidden lining
3. Material swatch strip without words:
   - mist purple
   - cold grey
   - deep ink blue
...
Return to the fugitive structure under a dark grey snowline cloak. Snow and frost may dull the outer layer, but her posture stays upright and controlled. Moon-white lining may flash only as a hidden inner edge; old empire identity remains concealed.

## Yan Nanzhi Negative Rules

- no redesigned Zhaoming badge
