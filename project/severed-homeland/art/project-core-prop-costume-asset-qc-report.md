...
| 资产 | 路径 | 状态 | 说明 |
| --- | --- | --- | --- |
| `costume_shen_weisang_states_v01` | `assets/costumes/history/costume_shen_weisang_states.v001.png` | 已归档候选，要求替换 | 整体方向可用，但火后状态衣摆与雪线披风破损偏重，已移入 history，等待重生成最终版。 |
...
| 主角与阵营服装资源板 | `019e890d-ae14-76e3-82a1-756235a7673c` | 已启动，沈维桑图已要求替换，其余等待图片回填 |
