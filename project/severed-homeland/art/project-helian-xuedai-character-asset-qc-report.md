...
|---|---|---|
| `character_helian_xuedai_multi_state_board_v03` | `project/severed-homeland/assets/characters/character_helian_xuedai_multi_state_board.png` | pass |
...
| Check | Result | Notes |
|---|---|---|
| Character identity | pass | 角色读作白熊族部落高级女护卫和礼仪执行者，不是鹿弥换装、霜蹄鹿族、低等部落民或萨满。 |
| Face direction | pass | 脸仍是人脸为主，脸型偏圆；圆熊耳、额侧/脸颊熊族纹路和细白绒毛提供熊族识别。 |
...
| Three-state continuity | pass | 高级近卫礼装、雪线护送战备装、族中礼仪执行装共享同一人脸圆脸、熊耳、面纹、白熊皮披、银黑胸甲和护卫装备。 |
...
| History hygiene | pass | canonical 输出路径只存放 v03 最终图，v001 和 v002 均保留在 `history/` 并使用版本后缀。 |

## Handoff Notes

Prompt Room 应使用 `character_helian_xuedai_multi_state_board_v03` 作为第 09 集远景护卫、鹿弥护送队伍和后续北境线白熊族高级重装近卫的主角色参考。单镜头中必须保留人脸偏圆、圆熊耳、熊族面纹、厚实肩背、白熊皮厚披、银黑骨铁胸甲、骨铁大盾、长柄护卫斧、青铜护腕、深褐护腹、大手短爪、青玉扣、暗红誓约绳和冰钉靴；如需使用北境阵营符号，只能引用既有万兽系统的骨木绳结、熊爪刻痕和誓约绳语言，不得生成新的熊族徽章或个人 crest。
