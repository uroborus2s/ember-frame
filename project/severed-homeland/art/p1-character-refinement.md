...
2. 把 v3 昭明/肃明徽章自然融合进角色道具、布条、内层纹样和官署标识。
...
| 晏南枝 | 流亡皇族公主。清冷整洁粗布外袍，隐藏周秦式旧帝国内层，红线束发，月白玉片。 | 不要衣衫褴褛；不要乞逃者；不要完整宫廷礼服或皇冠。 |
| 白翳 | 虫族清明院监察者。沿用 `char_bai_yi_v01` 的虫族官署方向：几丁质面部、复眼、薄翼披肩、虫蜡针、白册、v3 肃明小徽。 | 不要 `char_bai_yi_v02` 的“人戴面具”方向；不要黑甲武将；不要丢失虫族特征；不要写实昆虫翅膀标本。 |
...
| 薛临墙 | 边军老军户。旧甲片、厚衬袄、灰墙军布层、骨哨、长枪、雪线绑腿、反面旧日月布条。 | 不要整洁帝国军官；不要纯破布；不要错误黑日/普通日轮布条。 |
...
- 白翳自然精修新稿必须以 `assets/characters/v01/char_bai_yi_v01_sheet.png` 的虫族监察者设计为基础，以 `assets/characters/v03/char_bai_yi_v03_sheet.png` 只作为 v3 肃明徽章位置/规则参考；`char_bai_yi_v02` 废弃，不作为形象参考。
