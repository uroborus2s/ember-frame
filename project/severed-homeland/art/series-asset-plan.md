...
- 图片生成：旧 B00、B07、B06、B01、B02 批次曾生成 canonical PNG。角色、服装、道具、徽章和普通风格板属于设定参考卡，不因视频横屏合同而强制重做；地点主场景卡、shot override 和 F005 构图动作板按 `3840x2160`、`16:9` 横屏合同生成或重新 QC；分集参考帧按 `4096x2304`、`16:9` 横屏合同生成或重新 QC。2026-06-06 已将 B07 的 F005 重生为 `3840x2160`、`16:9` 横屏构图动作板并通过 QC；B07 具体色彩、材质、地域色板、势力符号、横屏宽屏构图和低魔光效数据已补入 `art/b07-style-reference-data.json`、资产索引、提示词和线程合同；未生成角色/地点/道具批次按各自资产类型单独派发。
- 产物日期：2026-06-06
