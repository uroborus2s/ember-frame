# 第12集：日月照着谁 Video Production Plan
...
## Render Order / 渲染顺序
- `001` `SC001-SH001` `FLF2V` status=`needs_asset` assets=10
- `002` `SC001-SH002` `I2V` status=`needs_asset` assets=10
- `003` `SC001-SH003` `REFERENCE_IMAGE` status=`needs_asset` assets=10
- `004` `SC001-SH004` `I2V` status=`needs_asset` assets=10
- `005` `SC001-SH005` `I2V` status=`needs_asset` assets=10
- `006` `SC001-SH006` `I2V` status=`needs_asset` assets=10
- `007` `SC001-SH007` `REFERENCE_IMAGE` status=`needs_asset` assets=10
- `008` `SC001-SH008` `I2V` status=`needs_asset` assets=10
- `009` `SC001-SH009` `I2V` status=`needs_asset` assets=10
- `010` `SC001-SH010` `I2V` status=`needs_asset` assets=10
- `011` `SC001-SH011` `I2V` status=`needs_asset` assets=10
- `012` `SC002-SH001` `FLF2V` status=`needs_asset` assets=9
- `013` `SC002-SH002` `FLF2V` status=`needs_asset` assets=9
- `014` `SC002-SH003` `REFERENCE_IMAGE` status=`needs_asset` assets=9
- `015` `SC002-SH004` `I2V` status=`needs_asset` assets=9
- `016` `SC002-SH005` `FLF2V` status=`needs_asset` assets=9
...
- `023` `SC003-SH001` `FLF2V` status=`needs_asset` assets=11
