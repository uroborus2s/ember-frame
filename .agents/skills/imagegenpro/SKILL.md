...
- the bell is five-thousand-year-old oxidized metal with cracks, dents, missing rim chips, old repairs, and only broken unreadable fragments of the Zhaoming sun-moon astrolabe emblem
...
- no complete clean emblem on the bell, no new decorative crest, no ivory/bone bell surface
...
- young soldier is alive and knocked down by gate impact aftershock: bracing hand, breathing, stunned, not dead
...
- beast army remains outside/below the wall as distant pressure; exterior view has snow haze, smoke and siege shapes only, no houses or city lights
...
- R004 是否只有同一墙顶女墙，没有第二道墙，墙外没有房屋/城市。
- 旗帜、黑石、旧木、积雪、旧金属警钟和破损昭明残徽是否与场景母版和背景一致。
